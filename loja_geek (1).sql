...
--
-- Host: 127.0.0.1
-- Tempo de geração: 09/09/2026 às 19:26
...
ALTER TABLE `itens_pedidos`
  ...
  ADD KEY `fk_itens_pedidos_pedido` (`id_pedido`),
  ADD KEY `fk_itens_pedidos_produto` (`id_produto`);
...
--
ALTER TABLE `itens_pedidos`
  ADD CONSTRAINT `fk_itens_pedidos_pedido` FOREIGN KEY (`id_pedido`) REFERENCES `pedidos` (`id_pedido`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_itens_pedidos_produto` FOREIGN KEY (`id_produto`) REFERENCES `produto` (`id_produto`) ON UPDATE CASCADE;
